...
if isempty(GROUP) 
  ...
  if nargin==1
    ...
    plot(x(GROUP==1),y(GROUP==1),['r',s],'markersize',ms); hold on
    plot(x(GROUP==2),y(GROUP==2),['y',s],'markersize',ms);
    plot(x(GROUP==3),y(GROUP==3),['g',s],'markersize',ms);
    plot(x(GROUP==4),y(GROUP==4),['c',s],'markersize',ms);
    plot(x(GROUP==5),y(GROUP==5),['b',s],'markersize',ms);
    plot(x(GROUP==6),y(GROUP==6),['m',s],'markersize',ms);
    plot(x(GROUP==7),y(GROUP==7),['k',s],'markersize',ms); 
...
if isempty(GROUP) 
  ...
  plot3(x(GROUP==1),y(GROUP==1),z(GROUP==1),['r',s]); hold on
  plot3(x(GROUP==2),y(GROUP==2),z(GROUP==2),['y',s]);
  plot3(x(GROUP==3),y(GROUP==3),z(GROUP==3),['g',s]);
  plot3(x(GROUP==4),y(GROUP==4),z(GROUP==4),['c',s]);
  plot3(x(GROUP==5),y(GROUP==5),z(GROUP==5),['b',s]);
  plot3(x(GROUP==6),y(GROUP==6),z(GROUP==6),['m',s]);
  plot3(x(GROUP==7),y(GROUP==7),z(GROUP==7),['k',s]); 
